...
class LilyError(Exception):
    """Racine de toutes les erreurs de Lily."""


class ConfigError(LilyError):
    """Fichier de configuration absent, illisible ou incohérent."""


class SchemaError(LilyError):
    """Signature de skill impossible à traduire en schéma d'outil."""


class PluginError(LilyError):
...
class EngineUnavailable(LilyError):
