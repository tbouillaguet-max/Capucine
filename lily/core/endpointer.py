...
class BargeInDetector:
    """Repère que l'utilisateur reprend la parole pendant que Lily répond.

    Le micro entend le haut-parleur : sans annulation d'écho, Lily se
    ...
    * une **durée de parole soutenue** exigée, pour qu'un claquement ne
    ...
    « éveil » — n'interrompre que si l'on redit « Lily » — reste le plus
    sûr.
    """
