...
``fork``, lui, est franchement dangereux ici : Lily tient plusieurs
...
def _executer(requete: dict[str, Any]) -> tuple[str, Any]:  # pragma: no cover - autre interpréteur
    ...
    from lily.core.plugin import PluginContext, register_context
...
def run_isolated(
    ...
    *,
    ...
    with tempfile.TemporaryDirectory(prefix="lily-isole-") as dossier:
        ...
        processus = subprocess.Popen(
            [sys.executable, "-m", "lily.core.isolation"],
