...
class Pipeline:
    ...
    def attach(self) -> None:
        """Branche ``lily.plugin.announce()`` sur la sortie de Lily.
    ...
    async def run_announcer(self, stop: asyncio.Event | None = None) -> None:
        ...
        Sans cette tâche de fond, un minuteur qui sonne pendant que Lily
    ...
    def notify_skill_change(self, added: list[str], removed: list[str]) -> None:
        ...
        fois par heure ; une Lily qui commente chaque sauvegarde devient
        vite insupportable.
        """
        for name in removed:
    ...
    def _synthetiser_et_jouer(self, phrase: str) -> bool:
        ...
        try:
            ...
            logger.warning("Sortie audio perdue (%s) ; Lily affichera ses réponses.", exc)
            self.audio_out = None
            print(f"Lily › {phrase}")
            return True
        except Exception:
    ...
    async def _traiter_confirmation(
        ...
        coup : Lily pose la question, et le tour suivant est lu comme un
    ...
    async def run_conversation(
        ...
        *,
        ...
        réponse : on enchaîne sans redire « Lily ».
        """
