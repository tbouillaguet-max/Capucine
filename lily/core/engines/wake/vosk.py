...
« lily » et ``[unk]``. Il ne peut littéralement rien reconnaître d'autre,
...
class VoskWakeWord(WakeWordEngine):
    ...
    def __init__(
        ...
        **_ignored: Any,
        ...
        # décodeur qui a le droit de dire « lili » se trompera moins qu'un
        # décodeur forcé de choisir entre « lily » et rien.
        self.variants = variants or [word, "lili", "ma lily"]
