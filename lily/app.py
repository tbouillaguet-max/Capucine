...
def build_assistant(
    ...
    *,
    ...
    # n'a pas à savoir que Lily a une voix.
...
async def run_text_mode(assistant: Assistant, once: str | None = None) -> int:
    ...
    try:
        ...
        print(f"Lily — mode texte ({assistant.llm.describe()}, profil "
...
async def run_voice_mode(
    ...
    *,
    ...
    """Trois façons de parler à Lily, du plus manuel au plus autonome.
    ...
    * défaut : écoute permanente, réveil sur « Lily », fin d'énoncé au
...
def _annoncer_moteurs(assistant: Assistant) -> None:
    print(
        f"Lily — mode vocal ({assistant.llm.describe()}, "
...
async def _boucle_clavier(assistant: Assistant, arret: asyncio.Event) -> None:
    """Les commandes restent accessibles pendant que Lily écoute."""
