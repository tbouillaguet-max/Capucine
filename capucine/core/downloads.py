...
jamais sortir sur le réseau sans qu'on le lui demande.
    ...
    python -m capucine.core.downloads voix fr_FR-siwis-medium
    python -m capucine.core.downloads whisper small
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(
        prog="python -m capucine.core.downloads",
        description="Télécharge les poids dont Capucine a besoin. Rien n'est fait automatiquement.",
    )
