...
``tools/entrainer_capucine.py`` réclame, et qu'on ne peut obtenir qu'en usage
réel.
...
* **Seule la fenêtre du mot d'éveil est gardée** — environ deux secondes qui
  se terminent juste après « Capucine ». Ce que vous dites ensuite n'est
  jamais enregistré.
