...
Le modèle « capucine » n'existe pas dans les modèles pré-entraînés : il faut
l'entraîner, ce que fait ``tools/entrainer_capucine.py``. Tant qu'il n'est pas
    ...
    def _get_model(self) -> Any:
        ...
        if chemin is None:
            raise EngineUnavailable(
                ...
                "« capucine » : entraînez-le avec\n"
                "  python tools/entrainer_capucine.py --preparer\n"
